...
def error_response(description):
    return jsonify({"status": "error", "description": description}), 200
...
def create_user():
    ...
    try:
        ...
        new_user = {"id": next_id, "name": name, "msisdn": msisdn}
...
def delete_user(id):
    ...
    try:
        ...
        return success_response({"message": f"User with id {id} deleted successfully"})
